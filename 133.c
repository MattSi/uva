 ...
 * 有2个官员，A从1开始逆时针数，B从n开始顺时针数。在每一轮中，官员A数K个就停下来，官员B数M个就停下来（注意，有可能两个官员停在同一个人身上）接下来，被选中的人（1个或2个）就离开队伍。
 *
 * 输入n，k，m。输入每轮被选中的人的编号。（如果有2个人，先输入被A选中的）
 *
 *
 *
 * */
